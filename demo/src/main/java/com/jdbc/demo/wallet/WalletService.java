...
public interface WalletService {
    ...
    Double withdrawFromWalletByEmailId(String emailId, Double amount) throws WalletException,WalletWithdrawException;
    ...
    Wallet findWalletsByName(String name) throws WalletException;
