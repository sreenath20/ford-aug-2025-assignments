...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Student student1 = new Student(5015,"Harini",97.8);
        Student student2 = new Student(5028,"Meena",98.8);
        Student student3 = new Student(5007,"Bindu",99.0);
        Student student4 = new Student(5042,"Santhuma",99.8);
        Student student5 = new Student(5042,"Santhuma",99.8);
