...
public class UserController {
    ...
    @PostMapping
    public UserTable addNewUser(@RequestBody UserTable newUser) {
    ...
    @PutMapping("/{id}/cart")
    public UserTable updateCartByUserId(@PathVariable Integer id, @RequestBody Cart cart) {
        return userService.updateCartByUserId(id,cart);
    }

    @PatchMapping("/{id}/cart/add")
    public UserTable addCartItemsByUserId(@PathVariable Integer id,@RequestBody Cart cart) {
        return userService.addItemsToCartByUserId(id,cart);
    }

    @PatchMapping("/{id}/cart/remove")
    public UserTable removeCartItemsByUserId(@PathVariable Integer id,@RequestBody Cart cart) {
